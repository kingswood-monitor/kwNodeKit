...
class kwSensor
{
  public:
     ...
     *
     * @param ostream The stream to encode readings to (see nanopb).
     ...
     */
    virtual bool readAndEncodeMeasurements(pb_ostream_t *ostream, const pb_field_iter_t *field, void *const *arg,
                                           bool rbeFlag) = 0;
...
bool processMeasurement(Measurement &measurement, double value, kwSensor::RBEConfig &rbeConfig, bool rbeFlag,
                        ...
                        const char *label, pb_ostream_t *ostream, const pb_field_iter_t *field);
